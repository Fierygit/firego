...
export function PopButton() {
    ...
    const PopBack = useCallback((e) => {
        history.goBack();
    }, [history]);

    return (
        <div className='sticky text-black dark:text-white top-0 w-full h-0 cursor-pointer' onClick={PopBack}>
            <svg className='absolute top-3 left-12 w-6 h-6 fill-current' viewBox="0 0 512 512">
                <g>
                    <g>

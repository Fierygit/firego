...
export function EditDialog({ oldName, editTodo, btnRef }) {
    ...
    return (
        <Fragment>
            ...
            <button ref={btnRef} className='absolute hidden group-hover:block transform right-6 md:right-9 w-8 md:w-10 h-4/5 hover:scale-125 select-none outline-none' onClick={() => setVisible(!visible)}>

            ...
            <div className='w-full min-h-screen z-10 fixed top-0 left-0 flex items-center justify-center bg-gray-900 bg-opacity-80' onClick={cancel}>
                <div className='flex items-center z-20 justify-center py-6 w-11/12 md:w-2/3 lg:w-1/2 flex-col bg-gray-100 dark:bg-gray-800 rounded-xl' onClick={e => e.stopPropagation()}>
                    ...
                    <div className='flex items-center justify-evenly w-full'>
                        <button className='rounded-lg w-1/5 h-7 bg-green-400 text-gray-100 dark:text-black font-bold select-none' onClick={(_) => confirm(todoName)}>confirm</button>
...
export function EditDialog({ oldName, editTodo, btnRef }) {
    ...
    return (
        <Fragment>
            ...
            <button ref={btnRef} className='absolute hidden group-hover:block transform right-6 md:right-9 w-8 md:w-10 h-4/5 hover:scale-125 outline-none' onClick={() => setVisible(!visible)}>
